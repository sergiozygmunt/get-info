...
import getSelectedHeadersFromResponse, { HeadersMap } from '../src/getSelectedHeaders'
    ...
    describe('Test Cases', () => {
        ...
        for (const testCase of testCases) {
            test(testCase.name, () => {
                ...
                const headers = getSelectedHeadersFromResponse(response.headers, testCase.input[1])
